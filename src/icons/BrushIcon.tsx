...
const BrushIcon = ({ width = "24px", height = "24px", color = "currentColor" }: IconProps) => (
  <svg width={width} height={height} className="cursor-pointer" viewBox="0 0 24 24" fill={color}>
